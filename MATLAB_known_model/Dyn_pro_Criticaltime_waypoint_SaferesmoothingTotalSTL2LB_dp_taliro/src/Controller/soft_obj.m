function [soft  hard] = soft_obj(s0, C, D, param, dim, T, STL2LB, b, char_TT, Map)
...
soft  = NN(STL2LB, reshape(Trajectory , [numel(Trajectory) , 1] ) , b) ;

[~,  hard] = Robustness( char_TT, Map, reshape(Trajectory , [numel(Trajectory) , 1] ) );
end