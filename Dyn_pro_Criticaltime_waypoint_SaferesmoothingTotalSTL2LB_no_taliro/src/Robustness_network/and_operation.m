function  STR  = and_operation(STR1,STR2)
...
t1_or   = strcmp(type1 , 'or'  ) || strcmp(type1 , 'leaf');  
t1_and  = strcmp(type1 , 'and' ) ;

t2_or   = strcmp(type2 , 'or'  ) || strcmp(type2 , 'leaf');  
t2_and  = strcmp(type2 , 'and' ) ;
...
if     t1_or && t2_or  %%% pack the first and  pack the second
...
elseif t1_or && t2_and  %%%  pack the first and  don't pack the second
...
elseif t1_and && t2_or  %%% don't pack the first and  pack the second
...
elseif t1_and && t2_and  %%% don't pack the first and  don't pack the second
