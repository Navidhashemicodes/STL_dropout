...
scl =10;
z=   exp(-F1  /((scl*FF)^2)) +  exp(-F2  /((scl*FF)^2))...
 +   exp(-F3  /((scl*FF)^2)) +  exp(-F4  /((scl*FF)^2))...
 +   exp(-F5  /((scl*FF)^2)) +  exp(-F6  /((scl*FF)^2))...
 +   exp(-F7  /((scl*FF)^2)) +  exp(-F8  /((scl*FF)^2))...
 +   exp(-F9  /((scl*FF)^2)) +  exp(-F10 /((scl*FF)^2))...
 +   exp(-F11 /((scl*FF)^2)) +  exp(-F12 /((scl*FF)^2))...
 +   exp(-F13 /((scl*FF)^2)) +  exp(-F14 /((scl*FF)^2))...
 +   exp(-F15 /((scl*FF)^2)) +  exp(-F16 /((scl*FF)^2))...
 +   exp(-F17 /((scl*FF)^2)) +  exp(-F18 /((scl*FF)^2))...
 +   exp(-F19 /((scl*FF)^2)) +  exp(-F20 /((scl*FF)^2));
end